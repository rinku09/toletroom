            ...
            <section id="agent_sec" class="col-md-8">
                ...
                <div class="row">
                    <div class="agen_info">
                        ...
                        <div class="col-md-4">
                            <a href="agents_single.php"><img class="img-responsive img-hover" src="http://placehold.it/270x260" alt="">
                            </a>
                        </div>
                        <div class="col-md-8">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="row agen_desc">
                                        <div class="col-md-8">
                                            <h3 class="sec_titl">
                            <a href="agents_single.php"> Scott Berends </a>                                   </h3>
                                            <p class="sec_desc">
                                                Buying Agents.₹
                                            </p>
                ...
                <div class="row">
                    <div class="agen_info">
                        ...
                        <div class="col-md-4">
                            <a href="agents_single.php"> <img class="img-responsive img-hover" src="http://placehold.it/270x260" alt=""> </a>
                        </div>
                        <div class="col-md-8">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="row agen_desc">
                                        <div class="col-md-8">
                                            <h3 class="sec_titl">
                                                <a href="agents_single.php">  Stanley Morgan  </a>                                   </h3>
                                            <p class="sec_desc">
                                                Buying Agents.₹
                                            </p>
                                    ...
                                    <div class="panel_bottom">
                                        <div class="agen_feat">
                                            ...
                                            <p class="bedrom">
                                                <a href="mailto:stanley@morgan.com?Subject=Agent%20enquiry"> <i class="fa fa-envelope"></i> stanley@morgan.com </a>
                                            </p>
                                            <p class="bedrom"><a href="skype:-scottberends1-?chat"><i class="fa fa-skype"></i> stanleymorgan </a> </p>
                                        </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="row agen_desc">
                                        <div class="col-md-8">
                                            <h3 class="sec_titl">
                                                <a href="agents_single.php"> Michelle Ferrara   </a>                                </h3>
                                            <p class="sec_desc">
                                                Buying Agents.₹
                                            </p>
                                    ...
                                    <div class="panel_bottom">
                                        <div class="agen_feat">
                                            ...
                                            <p class="bedrom">
                                                <a href="mailto:michelle@ferrara.com?Subject=Agent%20enquiry"> <i class="fa fa-envelope"></i> michelle@ferrara.com </a>
                                            </p>
                                            <p class="bedrom"><a href="skype:-michelle-?chat"><i class="fa fa-skype"></i> michelle </a> </p>
                                        </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="row agen_desc">
                                        <div class="col-md-8">
                                            <h3 class="sec_titl">
                                                <a href="agents_single.php">  Matthew Stalder       </a>                              </h3>
                                            <p class="sec_desc">
                                                Buying Agents.₹
                                            </p>
                                    ...
                                    <div class="panel_bottom">
                                        <div class="agen_feat">
                                            ...
                                            <p class="bedrom">
                                                <a href="mailto:matthew@stalder.com?Subject=Agent%20enquiry"> <i class="fa fa-envelope"></i> matthew@stalder.com </a>
                                            </p>
                                            <p class="bedrom"><a href="skype:-m.stalder-?chat"><i class="fa fa-skype"></i> m.stalder </a> </p>
                                        </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="row agen_desc">
                                        <div class="col-md-8">
                                            <h3 class="sec_titl">
                                                <a href="agents_single.php">      Thomas South       </a>                                </h3>
                                            <p class="sec_desc">
                                                Buying Agents.₹
                                            </p>
                                    ...
                                    <div class="panel_bottom">
                                        <div class="agen_feat">
                                            ...
                                            <p class="bedrom">
                                                <a href="mailto:thomas@south.com?Subject=Agent%20enquiry"> <i class="fa fa-envelope"></i> thomas@south.com </a>
                                            </p>
                                            <p class="bedrom"><a href="skype:-thomassouth-?chat"><i class="fa fa-skype"></i> thomassouth </a> </p>
                                        </div>
                    ...
                    <div class="side_feat">
                        <div class="panel panel-default">
                            <div class="panel-image col-md-3">
                                <a href="property_details.php"> <img class="img-responsive img-hover" src="http://placehold.it/100x100" alt=""> </a>
                            </div>
