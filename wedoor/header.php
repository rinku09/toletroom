...
<head>
    ...
    <!-- Owl room Assets -->
    <link href="css/owl.room.css" rel="stylesheet">
    <link href="css/owl.tolet.css" rel="stylesheet">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="property_listing.php"> Property Listings </a>
                            </li>
                            <li>
                                <a href="property_details.php"> Property Single </a>
                            </li>
                        </ul>
                    </li>
                    <li>
